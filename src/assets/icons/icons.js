...
export const IconLocationMap = ({ style = {}, size, color }) => <svg width={size} height={size} style={style} viewBox="0 0 49 48" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-287 -1776)" fill={color} fill-rule="nonzero"><g id="Prato" transform="translate(48 1708)"><g id="Alerta-endereço" transform="translate(239 68)"><path d="M25 45C13 36.96 7 28.96 7 21c0-9.941 8.059-18 18-18s18 8.059 18 18c0 7.96-6 15.96-18 24zm0-16a8 8 0 1 0 0-16 8 8 0 0 0 0 16z" id="Combined-Shape"></path></g></g></g></svg>